...
function getArticleTitle(article) {
    ...
    if (article.TroveListArticleViewedIdx === null || article.TroveListArticleViewedIdx < 0) return article.TroveListArticleHeading;
    //
    const viewedArticle = userData.viewedArticles[article.TroveListArticleViewedIdx];
    // console.log('UserListView/getArticleTitle - viewedArticle ', JSON.stringify(viewedArticle))
...
function openPersonList(personName) {
    ...
    if (personName.length > 0) {
        ...
        if (idxMetadataPerson < 0) {
            console.log(`UserListView/openPersonList Person Metaddata Type not found`)
            return
        }
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class=" row">
                ...
                <div class="col">
                    <div class="card">
                        <a @click.prevent="loadListArticles('false')" class="btn btn-primary" role="button">Reload List
                            from
                            Trove</a>
                    </div>
                </div>
