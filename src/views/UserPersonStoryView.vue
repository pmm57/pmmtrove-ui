...
let personStoryShowAll = ref(true)
personStoryShowAll.value = navStore.savedPerson.readPersonStoryShowAll
const filteredEvents = computed(() =>
    storyEvents.filter(a =>
        personStoryShowAll.value || a.include
    )
)
//
...
function saveShowAll() {
    let chgDetails = { chgPersonStoryShowAll: personStoryShowAll.value };
    navStore.savedPerson.action = 'CHG'
    useSavePersonData(navStore.savedPerson, chgDetails);
    navStore.savedPerson.readPersonStoryShowAll = personStoryShowAll.value
}
//
watch(
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col">
                    <div class="card">
                        <button type="button" class="btn btn-primary" :class="{ active: personStoryShowAll }"
                            :aria-pressed="personStoryShowAll" @click="personStoryShowAll = !personStoryShowAll"
                            :disabled="!updateDisabled">
                            <span v-if="personStoryShowAll">
                                <i class="bi-check-circle-fill"></i> Show All
                            </span>
                            <span v-else>
                                <i class="bi-circle"></i> Show All
                            </span>
                        </button>
                    </div>
                </div>
                <div v-if="personStoryShowAll != navStore.savedPerson.readPersonStoryShowAll" class="col">
                    <div class="card">
                        <button type="button" class="btn btn-primary" :class="{ active: personStoryShowAll }"
                            :aria-pressed="personStoryShowAll" @click="saveShowAll()" :disabled="!updateDisabled">
                            <span v-if="personStoryShowAll">
                                Save Show All
                            </span>
                            <span v-else>
                ...
                <div class="col">
                    <div class="card">
                        <button @click.prevent="reloadStory()" class="btn btn-primary"
                            :disabled="!updateDisabled">Reload
                            Story</button>
                    </div>
                </div>
                <div class="col">
