...
function handleLoadPersonMessage(e, intervalApersonData) {
    ...
    navStore.savedPerson.readPersonStoryShowAll = returnedData.personStoryShowAll
...
function addPerson() {
    ...
    navStore.savedPerson.readPersonStoryShowAll = true;
...
function delPerson(deletePerson, emptyPerson) {
    ...
    useSavePersonData(deletePerson, emptyPerson);
    initScreen('clear');
}
//
...
function chgPerson(preChgDetails, chgDetails, firstCall) {
    ...
    //
    useSavePersonData(preChgDetails, chgDetails);
    if (firstCall) {
        initScreen('clear')
    }
}
