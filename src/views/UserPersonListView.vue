    ...
    if ((firstCall) && (partners.value.length > 0)) {
      ...
      for (const partner of partners.value) {
        if (partner.action == 'CHG') {
          let partnerChange = {chgName: partner.readName,
          ...
          <div class="card-body">
            ...
            <div v-show="!showDefaultPersonAction">
              ...
              <div v-show="showSearchPerson" class="col">
                <div class="card">
                  <router-link
                    :to="'/searchTrove/' + updatePerson.chgName.replaceAll(' ', '%20') "
            ...
            <div v-show="showDelPerson" class="col">
              <div class="card">
                <button @click="delPerson(savedPerson, updatePerson)" class="btn btn-primary">Confirm Delete Person</button>
              </div>
            </div>
            <div v-show="showChgPerson" class="col">
              <div class="card">
                <button @click="chgPerson(savedPerson, updatePerson, true)" class="btn btn-primary" >Apply Updates to Person</button>
              </div>
            </div>
          </div>
